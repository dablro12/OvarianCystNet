...
class multi_exp_classification:
    ...
    def _get_ds_loader(self):
        ...
        train_loader = DataLoader(
            ...
            batch_size=24,
            # shuffle = True,
            sampler=BalancedBatchSampler(train_dataset, labels=train_dataset.labels_tensor, batch_size = 24), 
            num_workers=16,
    ...
    def _get_model_loader(self):
        ...
        scheduler = optim.lr_scheduler.CyclicLR(optimizer, base_lr=0.0000005, max_lr=0.000001, step_size_up=5, step_size_down=5, mode='triangular2')
        # scheduler = None
